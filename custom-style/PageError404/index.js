const CustomStyle = () => {
  return (
    <custom-style class="display-none">{`/* To 463px (next query overtakes 464px): */
    ...
    */
    ...
    /* We have to chain .main to .error-404 to increase the specificity to make the styling work */
    .error-404.main p {
      max-width: 27em;
    }
    `}</custom-style>
